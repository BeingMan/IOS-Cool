...
+(NSMutableArray*)LetterSortArray:(NSArray*)stringArr
{
    ...
    for (NSString* object in tempArray) {
        ...
        pinyin= [((ChineseString*)object).pinYin substringToIndex:1];
        string = ((ChineseString*)object).string;
...
+(NSMutableArray*)ReturnSortChineseArrar:(NSArray*)stringArr
{
    ...
    for(int i=0;i<[stringArr count];i++)
    {
        ...
        Contact * obj = [stringArr objectAtIndex:i];
        NSString * tempStr = obj.name;
        
        chineseString.string = [NSString stringWithString:tempStr];
